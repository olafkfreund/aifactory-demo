...
// playable starting state: a 9-cell (3x3) board, an "X's turn" status, and a
// "New game" control. If any of these require a server or build step, loading
// over file:// would fail and these assertions would not hold.
...
test.describe('tic-tac-toe loads playable over file:// (AC#1)', () => {
  ...
  test('exposes a "New game" control', async ({ page }) => {
