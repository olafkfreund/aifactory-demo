...
// clicked cell shows the acting player's mark and the #status region advances
// to the other player's turn. This test loads the page directly over file://
// (no server, no build step), clicks empty cells, and asserts each click
// renders the acting player's mark and flips the status text.
